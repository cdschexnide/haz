...
export const checkA19_3_2_10QuantityLimitsForLimitedConditions = (
  ...
  if (physicalState === PhysicalState.SOLID) {
    ...
    if (
      ...
      return {
        isApplicable: true,
        isLimited: false,
        reason: `Per Table A19.2, the hazardous material exceeds quantity limits for inner packagings (${limits.innerPackagingQuantityLimit.g}g) for Hazard Class/Division 8, Packing Group ${material.packingGroup}.`,
        applicableRule: "Table A19.2",
      };
    }
    ...
    if (
      ...
      return {
        isApplicable: true,
        isLimited: false,
        reason: `Per Table A19.2, the hazardous material exceeds quantity limits per package (${limits.quantityLimitPerPackage.g}g) for Hazard Class/Division 8, Packing Group ${material.packingGroup}.`,
        applicableRule: "Table A19.2",
      };
    }
    ...
    return {
      ...
      isLimited: true,
      reason:
        "Material meets limited quantity requirements for Class 8 solids (excluding prohibited UNIDs) per Table A19.2.",
      applicableRule: "A19.3.2.10",
    };
  }
  ...
  if (physicalState === PhysicalState.LIQUID) {
    ...
    if (
      ...
      return {
        isApplicable: true,
        isLimited: false,
        reason: `Per Table A19.2, the hazardous material exceeds quantity limits for inner packagings (${limits.innerPackagingVolumeLimit.mL}mL) for Hazard Class/Division 8, Packing Group ${material.packingGroup}.`,
        applicableRule: "Table A19.2",
      };
    }
    ...
    if (
      ...
      return {
        isApplicable: true,
        isLimited: false,
        reason: `Per Table A19.2, the hazardous material exceeds quantity limits per package (${limits.volumeLimitPerPackage.mL}mL) for Hazard Class/Division 8, Packing Group ${material.packingGroup}.`,
        applicableRule: "Table A19.2",
      };
    }
    ...
    return {
      ...
      isLimited: true,
      reason:
        "Material meets limited quantity requirements for Class 8 liquids (excluding prohibited UNIDs) per Table A19.2.",
      applicableRule: "A19.3.2.10",
    };
  }
  ...
  return {
    ...
    isLimited: false,
    reason:
      "Physical state is required to determine limited quantity eligibility for Hazard Class/Division 8.",
    applicableRule: "Table A19.2",
  };
};
