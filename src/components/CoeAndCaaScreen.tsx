...
const CoeAndCaaScreen = ({ navigation }: { navigation: any }) => {
  ...
  const [documentType, setDocumentType] = useState<"COE" | "CAA">("COE");
  ...
  const renderDocuments = () => {
    const coeDocuments =
      state.hazProPreparerContext.coeAndCaaDocuments?.coeDocuments || [];
    const caaDocuments =
      state.hazProPreparerContext.coeAndCaaDocuments?.caaDocuments || [];
...
export default CoeAndCaaScreen;
