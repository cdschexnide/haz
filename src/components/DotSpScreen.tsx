...
const DotSpScreen = ({ navigation }: { navigation: any }) => {
  ...
  const convertImagesToPdf = async () => {
    ...
    try {
      ...
      const prev = state.hazProPreparerContext.dotSpWaivers || [];
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            const updatedWaivers = dotSpWaivers.filter(doc => doc.id !== id);
