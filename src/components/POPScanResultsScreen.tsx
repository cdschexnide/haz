/**
 * POPScanResultsScreen - Debug/review screen showing OCR extraction results
 *
 * Displays:
...
const POPScanResultsScreen: React.FC<POPScanResultsScreenProps> = ({
  navigation,
  route,
}) => {
  ...
  console.log("=== POPScanResultsScreen Mounted ===");
  ...
  const handleContinue = () => {
    console.log("User clicked Continue - navigating to POPMarkingDataEntry");
    // Fields are already populated in store by POPScannerScreen
    // Use navigationRef to navigate to POPMarkingDataEntry in WrappedStack
    navigate("POPMarkingDataEntry");
  };
  ...
  const handleEditManually = () => {
    console.log(
      "User clicked Edit Manually - clearing fields and navigating to POPMarkingDataEntry"
    );
...
export default POPScanResultsScreen;
