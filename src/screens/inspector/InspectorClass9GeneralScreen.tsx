...
interface InspectorClass9GeneralScreenProps {
  navigation: any;
}

// AFMAN 24-604 A13.14 Class 9 General Materials Inspection Conditions
const CLASS9_GENERAL_INSPECTION_CONDITIONS = [
  {
    id: "non-bulk-packaging",
    label: "Appropriate non-bulk packaging used",
    description:
      "Use appropriate non-bulk packaging meeting Attachment 3 requirements; UN specification packaging is not required.",
    afmanRef: "AFMAN 24-604 A13.14",
  },
  {
    id: "outage-provided",
    label: "Outage provided for liquid packagings",
    description:
      "For packagings 208 L (55 gallon) or less, provide enough outage so the packaging is not liquid-full at 54 degrees C.",
    afmanRef: "AFMAN 24-604 A13.14",
  },
  {
    id: "vapor-pressure",
    label: "Primary packaging withstands vapor pressure",
    description:
      "If absolute vapor pressure exceeds 110 kPa at 38 degrees C, ensure the primary packaging withstands internal pressure at 54 degrees C without leakage.",
    afmanRef: "AFMAN 24-604 A13.14",
  },
  {
    id: "water-reactive",
    label: "Water-reactive materials use waterproof packaging",
    description:
      "If water-reactive, use inner or outer waterproof packaging.",
    afmanRef: "AFMAN 24-604 A13.14",
  },
];

export default function InspectorClass9GeneralScreen({
  navigation,
}: InspectorClass9GeneralScreenProps) {
  ...
  const currentCondition = CLASS9_GENERAL_INSPECTION_CONDITIONS[currentStep];
  const totalSteps = CLASS9_GENERAL_INSPECTION_CONDITIONS.length;
  ...
  const DEFAULT_FRUSTRATION_MESSAGE =
    "This Class 9 general materials inspection condition is not met. Requires re-inspection per AFMAN 24-604 A13.14.";
  ...
  const handleSaveFrustration = () => {
    const frustrationData = {
      category: "class9-general" as const,
    ...
    console.log(
      "💾 [InspectorClass9General] Saving frustration for condition:",
      currentCondition.id
    );
  ...
  const handleFinalSubmit = () => {
    ...
    if (currentFrustrations.length === 0) {
      Alert.alert(
        "Class 9 General Materials Inspection Complete",
        "All A13.14 conditions have been validated successfully.\n\nNo compliance issues were found. Proceeding to package summary.",
        [
  ...
  if (unId !== "UN1841" && unId !== "UN3334" && unId !== "UN3335") {
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.errorContainer}>
          <Text style={styles.errorText}>
            Invalid material type for Class 9 general materials inspection
          </Text>
          <TouchableOpacity
