...
// AFMAN 24-604 A13.20 Internal Combustion Engines/Machinery Inspection Conditions
const ENGINES_INSPECTION_CONDITIONS = [
  {
    id: "technical-manuals",
    label: "Prepared per service technical manual",
    description:
      "Prepare equipment per the service technical manual requirements.",
    afmanRef: "AFMAN 24-604 A13.20",
  },
  {
    id: "fuel-limits",
    label: "Fuel limits met",
    description:
      "Drain to 500 mL residual in tanks/lines (or as required by manual); special exceptions for wheeled equipment and large fuel systems apply.",
    afmanRef: "AFMAN 24-604 A13.20",
  },
  {
    id: "drain-purge-damaged",
    label: "Drain/purge damaged or inoperable engines",
    description:
      "Drain to maximum extent for damaged/inoperable engines; cap and cover openings; drained and purged engines with no other hazmat are non-hazardous.",
    afmanRef: "AFMAN 24-604 A13.20",
  },
  {
    id: "orientation-secured",
    label: "Orientation secured when needed",
    description:
      "Secure in strong, rigid outer packaging if orientation could change and cause leakage or damage.",
    afmanRef: "AFMAN 24-604 A13.20",
  },
  {
    id: "freight-containers",
    label: "Freight container procedures followed",
    description:
      "Drain fuel, purge if required or if flash point under 38 degrees C; if no procedures, drain, run engine until stall, leave open 24 hours, and ensure batteries are non-spillable or non-regulated.",
    afmanRef: "AFMAN 24-604 A13.20",
  },
  {
    id: "spill-risk",
    label: "Spill risk controls applied",
    description:
      "If unit is susceptible to spills per A3.3.3.6, drain and cap.",
    afmanRef: "AFMAN 24-604 A13.20",
  },
  {
    id: "battery-accessorial",
    label: "Battery and accessorial hazards controlled",
    description:
      "Batteries upright in holders, terminals protected; remove acid/alkali batteries for freight containers per A12.4; non-spillable batteries may remain if upright and disconnected.",
    afmanRef: "AFMAN 24-604 A13.20",
  },
];
...
export default function InspectorEnginesInternalCombustionScreen({
  ...
  const currentCondition = ENGINES_INSPECTION_CONDITIONS[currentStep];
  const totalSteps = ENGINES_INSPECTION_CONDITIONS.length;
  ...
  const DEFAULT_FRUSTRATION_MESSAGE =
    "This internal combustion engine/machinery inspection condition is not met. Requires re-inspection per AFMAN 24-604 A13.20.";
  ...
  const handleFinalSubmit = () => {
    ...
    if (currentFrustrations.length === 0) {
      Alert.alert(
        "Internal Combustion Inspection Complete",
        "All A13.20 conditions have been validated successfully.\n\nNo compliance issues were found. Proceeding to package summary.",
        [
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.errorContainer}>
          <Text style={styles.errorText}>
            Invalid material type for internal combustion inspection
          </Text>
          <TouchableOpacity
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScreenHeader
          title="UN3528/UN3529 Internal Combustion"
